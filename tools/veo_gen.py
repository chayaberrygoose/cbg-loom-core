...
_GARMENT_FIDELITY_LOCK = (
    ...
    "1) Print integrity: the all-over print on this garment is a fixed, pre-existing texture map "
    "baked onto the fabric. It must be reproduced exactly as shown in the reference image — "
    "every colour field, line, and illustrated element is already determined and must not be "
    "redrawn, reinterpreted, simplified, or altered in any way. "
    "This includes any animal figures, characters, or illustrated creatures that appear in the print: "
    "they are locked graphical data, NOT generatable subjects. "
    "Do not regenerate, reimagine, or stylise them — copy them verbatim from the reference. "
    "CRITICAL: do NOT duplicate, repeat, or add extra instances of any illustrated element "
    "(including animal figures or characters) anywhere on the garment. "
    "Each element appears exactly where the reference image shows it — no more, no fewer. "
    "If a section of print is not clearly visible in a given frame, leave it as fabric texture "
    "rather than inventing or repeating detail. "
    "The back of the garment must only show the print that is visible in the back reference image — "
    "do not carry over or duplicate elements from the front. "
    "2) Camera behaviour: treat ALL print elements — logos, emblems, illustrated figures — "
    "as flat, passive surface texture, not as focal points. "
