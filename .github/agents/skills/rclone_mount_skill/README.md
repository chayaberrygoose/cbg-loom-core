...
```bash
python3 .github/agents/skills/rclone_mount_skill/rclone_mount_skill.py --remote <remote_name> --path <mount_path>
```
...
```bash
python3 .github/agents/skills/rclone_mount_skill/rclone_mount_skill.py --remote cbg-share --path /home/cbg/repos/cbg-share
```
